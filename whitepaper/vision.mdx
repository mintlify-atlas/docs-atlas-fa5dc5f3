---
title: "The Vision"
description: "From on/off-ramps to a privacy and credibility-based economy"
---

## From "ramps" to a privacy and credibility based economy
...
## What P2P Protocol is (and is not)
...
## North-star outcomes (what "good" looks like to us)
...
## Credibility-based DeFi (beyond over-collateralization)
...
## A protocol for people, not just power users
...
## Programmable compliance (policy without dossiers)
...
## What gets unlocked if we get this right
...
## Stewardship & governance philosophy
...
- **Roadmap features:** for current feature-track proposals (including remittance and currency expansion), see [`/for-builders`](/builders/start-here).
