...
description: "Decentralized ownership of critical P2P infrastructure"
---
...
Holders vote on fees, limits, merchant rules, and treasury allocation. No single operator controls these decisions.

### Trust Staking ("Circles of Trust")

Token holders stake $P2P on merchant liquidity pools to attest to their trustworthiness, earning stablecoin yield from the Circle's transaction revenue.

### Revenue-Linked Ownership

20% of protocol revenue flows to the treasury, planned to increase to 35% as the protocol matures—subject to MetaDAO futarchy governance. The treasury can fund buy-and-burn or other value-accruing actions, directly connecting token value to network usage and growth.

### Censorship Resistance

Decentralized ownership means no single point of failure. The protocol can survive regulatory pressure in any one jurisdiction because control is distributed globally among token holders.